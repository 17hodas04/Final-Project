...
class Sound:
    def __init__(self):
        self.hit_sound = pg.mixer.Sound('assets/sounds/hit.wav')
        self.point_sound = pg.mixer.Sound('assets/sounds/point.wav')
        self.wing_sound = pg.mixer.Sound('assets/sounds/wing.wav')
